...
var translations = {
    en: {
        ...
        importStatusShow: "Show",
        importStatusConflict: "Conflict",
        importStatusImportError: "Import error",
        importStatusImportPaused: "Import paused",
        ...
        updateAvailableContext: "Comic Pile found a newer portable release. Review what changed, then download the update when you're ready.",
        updateAvailableReleaseNotesFallback: "No detailed release notes were provided for this update.",
        updateAvailableLater: "Later",
        updateAvailableDownload: "Download update",
        updateDownloadTitle: "Downloading update",
        updateDownloadContext: "Comic Pile is downloading the portable update package.",
        updateDownloadReadyContext: "The portable update package is ready.",
        updateDownloadPreparingFile: "Preparing update package...",
        updateDownloadProgressTitle: "Download progress",
        updateDownloadReadyTitle: "Ready to install",
        updateDownloadReadyMessage: "Press Install update to close Comic Pile and apply it now.",
        updateDownloadSizeKnown: "{downloaded} of {total} downloaded",
        updateDownloadSizeUnknown: "{downloaded} downloaded",
        ...
        readerShortcutToggleZoomTool: "Toggle zoom tool",
        readerShortcutTogglePageZoom: "Hold for page zoom",
        ...
        readerToastPageZoomToolEnabled: "Page zoom tool is enabled",
        readerToastPageZoomToolDisabled: "Page zoom tool is disabled",
        readerToastPageZoomEnabled: "Page zoom is enabled",
        readerToastPageZoomDisabled: "Page zoom is disabled",
        ...
        settingsGeneralAppLanguageScopeNote: "App language changes interface text and help text; screenshots may show English UI.",
        ...
        settingsReaderZoomTool: "Zoom tool",
        ...
        aboutTitle: "About",
        aboutSubtitle: "comic reader and library manager",
        aboutCreatedBy: "Created by",
        aboutMadeWith: "Made with",
        aboutBuiltWith: "Built with",
        aboutLicenses: "Licenses",
        aboutProjectLicense: "Project License",
        aboutQtLicenses: "Qt Licenses",
        aboutThirdPartyLicenses: "Third-Party Licenses",
        aboutSourceCode: "Source Code",
        aboutGitHubRepository: "GitHub Repository",
        aboutBuild: "Build",
        aboutUpdates: "Updates",
        aboutCheckingForUpdates: "Checking...",
        aboutUpToDate: "You are up to date",
        aboutCheckForUpdates: "Check for updates",
        aboutViewUpdate: "View update",
        aboutFooterOpenSource: "© 2026 Open-source project",

        whatsNewPatchNotes: "Patch notes",
        whatsNewNoBundledNotes: "No bundled release notes are available for this build.",
        whatsNewViewAvailableUpdate: "View available update",
        helpScreenshot: "Screenshot",
        replaceSourceMessage: "Choose what you want to replace the issue with.",
        replaceSourceHint: "You can replace it with another archive file or with a folder of ordered page images.",
        replaceSourceImageFolder: "Image folder",
        replaceSourceArchiveFile: "Archive file",

        deleteArchiveTitle: "Delete Archive File",
        deleteArchiveMessage: "Delete archive file from database?",
        deleteSeriesTitle: "Delete Series Files",
        deleteSeriesMultipleQuestion: "Delete files for {seriesCount} series ({issueCount} issues) from disk?",
        deleteSeriesSingleQuestionPrefix: "Delete files for series ",
        deleteSeriesSingleQuestionSuffix: " from disk?",
        ...
        seriesHeaderTitle: "Series Header",
        seriesHeaderTheme: "Theme",
        seriesHeaderMainCover: "Main cover",
        seriesHeaderBackground: "Background",
        seriesHeaderShuffle: "Shuffle",
        seriesHeaderUploadCover: "Upload\ncover",
        seriesHeaderUploadBackground: "Upload\nbackground",
        seriesHeaderResetToDefault: "Reset to default",
    ...
    es: {
        ...
        updateAvailableContext: "Comic Pile encontró una versión portable más reciente. Revisa qué cambió y descarga la actualización cuando quieras.",
        updateAvailableReleaseNotesFallback: "No se incluyeron notas detalladas para esta actualización.",
        ...
        updateDownloadContext: "Comic Pile está descargando el paquete portable de actualización.",
        updateDownloadReadyContext: "El paquete portable de actualización está listo.",
        updateDownloadPreparingFile: "Preparando paquete de actualización...",
        updateDownloadProgressTitle: "Progreso de descarga",
        updateDownloadReadyTitle: "Listo para instalar",
        updateDownloadReadyMessage: "Pulsa Instalar actualización para cerrar Comic Pile y aplicarlo ahora.",
        updateDownloadSizeKnown: "{downloaded} de {total} descargados",
        updateDownloadSizeUnknown: "{downloaded} descargados",
        ...
        readerShortcutToggleZoomTool: "Alternar herramienta de zoom",
        readerShortcutTogglePageZoom: "Mantener para zoom de página",
        ...
        readerToastPageZoomToolEnabled: "La herramienta de zoom de página está activada",
        readerToastPageZoomToolDisabled: "La herramienta de zoom de página está desactivada",
        readerToastPageZoomEnabled: "El zoom de página está activado",
        readerToastPageZoomDisabled: "El zoom de página está desactivado",
        ...
        seriesHeaderTitle: "Encabezado de serie",
        seriesHeaderTheme: "Tema",
        seriesHeaderMainCover: "Portada principal",
        seriesHeaderBackground: "Fondo",
        seriesHeaderShuffle: "Aleatorio",
        seriesHeaderUploadCover: "Subir\nportada",
        seriesHeaderUploadBackground: "Subir\nfondo",
        seriesHeaderResetToDefault: "Restablecer predeterminado",
        seriesHeaderContextMissing: "Falta el contexto de la serie.",
        seriesHeaderPrepareShuffleFailed: "No se pudo preparar el fondo aleatorio.",
        seriesHeaderSaveFailed: "No se pudieron guardar las imágenes del encabezado de serie.",
        ...
        settingsGeneralAppLanguageScopeNote: "El idioma de la app cambia los textos de la interfaz y la ayuda; las capturas pueden mostrar la interfaz en inglés.",
        ...
        settingsReaderZoomTool: "Herramienta de zoom",
        ...
        issueMenuEdit: "Editar",
        issueMenuReplace: "Reemplazar",
        issueMenuDelete: "Eliminar",
        ...
        aboutSubtitle: "lector de cómics y gestor de biblioteca",
        aboutCreatedBy: "Creado por",
        aboutMadeWith: "Hecho con",
        aboutBuiltWith: "Creado con",
        aboutLicenses: "Licencias",
        aboutProjectLicense: "Licencia del proyecto",
        aboutQtLicenses: "Licencias de Qt",
        aboutThirdPartyLicenses: "Licencias de terceros",
        aboutSourceCode: "Código fuente",
        aboutGitHubRepository: "Repositorio de GitHub",
        aboutBuild: "Compilación",
        aboutUpdates: "Actualizaciones",
        aboutCheckingForUpdates: "Comprobando...",
        aboutUpToDate: "Actualizado",
        aboutCheckForUpdates: "Buscar actualizaciones",
        aboutViewUpdate: "Ver actualización",
        aboutFooterOpenSource: "© 2026 Proyecto de código abierto",
        whatsNewPatchNotes: "Notas del parche",
        whatsNewNoBundledNotes: "No hay notas de versión incluidas para esta compilación.",
        whatsNewViewAvailableUpdate: "Ver actualización disponible",
        helpScreenshot: "Captura de pantalla",
        replaceSourceMessage: "Elige con qué quieres reemplazar este número.",
        replaceSourceHint: "Puedes reemplazarlo con otro archivo comprimido o con una carpeta de imágenes de páginas ordenadas.",
        replaceSourceImageFolder: "Carpeta de imágenes",
        replaceSourceArchiveFile: "Archivo comprimido",
        deleteArchiveTitle: "Eliminar archivo",
        deleteArchiveMessage: "¿Eliminar el archivo de la base de datos?",
        deleteSeriesTitle: "Eliminar archivos de la serie",
        deleteSeriesMultipleQuestion: "¿Eliminar del disco los archivos de {seriesCount} series ({issueCount} números)?",
        deleteSeriesSingleQuestionPrefix: "¿Eliminar del disco los archivos de la serie ",
        deleteSeriesSingleQuestionSuffix: "?",
    ...
    de: {
        ...
        updateAvailablePatchLabel: "Patch {version}",
        updateAvailableContext: "Comic Pile hat eine neuere portable Version gefunden. Prüfe, was sich geändert hat, und lade das Update herunter, wenn du bereit bist.",
        updateAvailableReleaseNotesFallback: "Für dieses Update wurden keine detaillierten Versionshinweise bereitgestellt.",
        updateAvailableLater: "Später",
        updateAvailableDownload: "Update herunterladen",
        updateDownloadTitle: "Update wird heruntergeladen",
        updateDownloadContext: "Comic Pile lädt das portable Update-Paket herunter.",
        updateDownloadReadyContext: "Das portable Update-Paket ist bereit.",
        updateDownloadPreparingFile: "Update-Paket wird vorbereitet...",
        updateDownloadProgressTitle: "Downloadfortschritt",
        updateDownloadReadyTitle: "Bereit zur Installation",
        updateDownloadReadyMessage: "Klicke auf Update installieren, um Comic Pile zu schließen und es jetzt anzuwenden.",
        updateDownloadSizeKnown: "{downloaded} von {total} heruntergeladen",
        updateDownloadSizeUnknown: "{downloaded} heruntergeladen",
        ...
        readerShortcutToggleZoomTool: "Zoomwerkzeug umschalten",
        readerShortcutTogglePageZoom: "Für Seitenzoom gedrückt halten",
        ...
        readerToastPageZoomToolEnabled: "Seitenzoom-Werkzeug ist aktiviert",
        readerToastPageZoomToolDisabled: "Seitenzoom-Werkzeug ist deaktiviert",
        readerToastPageZoomEnabled: "Seitenzoom ist aktiviert",
        readerToastPageZoomDisabled: "Seitenzoom ist deaktiviert",
        ...
        seriesHeaderTitle: "Serienkopf",
        seriesHeaderTheme: "Design",
        seriesHeaderMainCover: "Hauptcover",
        seriesHeaderBackground: "Hintergrund",
        seriesHeaderShuffle: "Zufällig",
        seriesHeaderUploadCover: "Cover\nhochladen",
        seriesHeaderUploadBackground: "Hintergrund\nhochladen",
        seriesHeaderResetToDefault: "Auf Standard zurücksetzen",
        seriesHeaderContextMissing: "Serienkontext fehlt.",
        seriesHeaderPrepareShuffleFailed: "Zufälliger Hintergrund konnte nicht vorbereitet werden.",
        seriesHeaderSaveFailed: "Serienkopf-Bilder konnten nicht gespeichert werden.",
        ...
        settingsGeneralAppLanguageScopeNote: "Die App-Sprache ändert Oberflächentexte und Hilfetexte; Screenshots können englische UI zeigen.",
        ...
        settingsReaderZoomTool: "Zoomwerkzeug",
        ...
        issueMenuEdit: "Bearbeiten",
        issueMenuReplace: "Ersetzen",
        issueMenuDelete: "Löschen",
        ...
        topMenuAbout: "Info",
        aboutTitle: "Info",
        aboutSubtitle: "Comic-Reader und Bibliotheksverwaltung",
        aboutCreatedBy: "Erstellt von",
        aboutMadeWith: "Gemacht mit",
        aboutBuiltWith: "Gebaut mit",
        aboutLicenses: "Lizenzen",
        aboutProjectLicense: "Projektlizenz",
        aboutQtLicenses: "Qt-Lizenzen",
        aboutThirdPartyLicenses: "Drittanbieter-Lizenzen",
        aboutSourceCode: "Quellcode",
        aboutGitHubRepository: "GitHub-Repository",
        aboutBuild: "Build",
        aboutUpdates: "Updates",
        aboutCheckingForUpdates: "Wird geprüft...",
        aboutUpToDate: "Aktuell",
        aboutCheckForUpdates: "Nach Updates suchen",
        aboutViewUpdate: "Update anzeigen",
        aboutFooterOpenSource: "© 2026 Open-Source-Projekt",
        whatsNewPatchNotes: "Patchnotes",
        whatsNewNoBundledNotes: "Für diesen Build sind keine gebündelten Versionshinweise verfügbar.",
        whatsNewViewAvailableUpdate: "Verfügbares Update anzeigen",
        helpScreenshot: "Screenshot",
        replaceSourceMessage: "Wähle aus, womit du diese Ausgabe ersetzen möchtest.",
        replaceSourceHint: "Du kannst sie durch eine andere Archivdatei oder einen Ordner mit sortierten Seitenbildern ersetzen.",
        replaceSourceImageFolder: "Bildordner",
        replaceSourceArchiveFile: "Archivdatei",
        deleteArchiveTitle: "Archivdatei löschen",
        deleteArchiveMessage: "Archivdatei aus der Datenbank löschen?",
        deleteSeriesTitle: "Seriendateien löschen",
        deleteSeriesMultipleQuestion: "Dateien für {seriesCount} Serien ({issueCount} Ausgaben) vom Datenträger löschen?",
        deleteSeriesSingleQuestionPrefix: "Dateien für die Serie ",
        deleteSeriesSingleQuestionSuffix: " vom Datenträger löschen?",
    ...
    fr: {
        ...
        updateAvailableContext: "Comic Pile a trouvé une version portable plus récente. Vérifie ce qui a changé, puis télécharge la mise à jour quand tu es prêt.",
        updateAvailableReleaseNotesFallback: "Aucune note détaillée n'a été fournie pour cette mise à jour.",
        ...
        updateDownloadContext: "Comic Pile télécharge le paquet portable de mise à jour.",
        updateDownloadReadyContext: "Le paquet portable de mise à jour est prêt.",
        updateDownloadPreparingFile: "Préparation du paquet de mise à jour...",
        updateDownloadProgressTitle: "Progression du téléchargement",
        updateDownloadReadyTitle: "Prêt à installer",
        updateDownloadReadyMessage: "Clique sur Installer la mise à jour pour fermer Comic Pile et l'appliquer maintenant.",
        updateDownloadSizeKnown: "{downloaded} sur {total} téléchargés",
        updateDownloadSizeUnknown: "{downloaded} téléchargés",
        ...
        readerShortcutToggleZoomTool: "Activer l’outil de zoom",
        readerShortcutTogglePageZoom: "Maintenir pour zoomer la page",
        ...
        readerToastPageZoomToolEnabled: "L’outil de zoom de page est activé",
        readerToastPageZoomToolDisabled: "L’outil de zoom de page est désactivé",
        readerToastPageZoomEnabled: "Le zoom de page est activé",
        readerToastPageZoomDisabled: "Le zoom de page est désactivé",
        ...
        seriesHeaderTitle: "En-tête de série",
        seriesHeaderTheme: "Thème",
        seriesHeaderMainCover: "Couverture principale",
        seriesHeaderBackground: "Arrière-plan",
        seriesHeaderShuffle: "Aléatoire",
        seriesHeaderUploadCover: "Importer\ncouverture",
        seriesHeaderUploadBackground: "Importer\narrière-plan",
        seriesHeaderResetToDefault: "Rétablir par défaut",
        seriesHeaderContextMissing: "Le contexte de série est manquant.",
        seriesHeaderPrepareShuffleFailed: "Impossible de préparer l'arrière-plan aléatoire.",
        seriesHeaderSaveFailed: "Impossible d'enregistrer les images d'en-tête de série.",
        ...
        settingsGeneralAppLanguageScopeNote: "La langue de l'application change les textes de l'interface et de l'aide ; les captures peuvent montrer l'interface en anglais.",
        ...
        settingsReaderZoomTool: "Outil de zoom",
        ...
        issueMenuEdit: "Modifier",
        issueMenuReplace: "Remplacer",
        issueMenuDelete: "Supprimer",
        ...
        aboutTitle: "À propos",
        aboutSubtitle: "lecteur de BD et gestionnaire de bibliothèque",
        aboutCreatedBy: "Créé par",
        aboutMadeWith: "Fait avec",
        aboutBuiltWith: "Construit avec",
        aboutLicenses: "Licences",
        aboutProjectLicense: "Licence du projet",
        aboutQtLicenses: "Licences Qt",
        aboutThirdPartyLicenses: "Licences tierces",
        aboutSourceCode: "Code source",
        aboutGitHubRepository: "Dépôt GitHub",
        aboutBuild: "Build",
        aboutUpdates: "Mises à jour",
        aboutCheckingForUpdates: "Vérification...",
        aboutUpToDate: "Tu es à jour",
        aboutCheckForUpdates: "Rechercher des mises à jour",
        aboutViewUpdate: "Voir la mise à jour",
        aboutFooterOpenSource: "© 2026 Projet open source",
        whatsNewPatchNotes: "Notes de patch",
        whatsNewNoBundledNotes: "Aucune note de version intégrée n'est disponible pour ce build.",
        whatsNewViewAvailableUpdate: "Voir la mise à jour disponible",
        helpScreenshot: "Capture d'écran",
        replaceSourceMessage: "Choisis avec quoi remplacer ce numéro.",
        replaceSourceHint: "Tu peux le remplacer par une autre archive ou par un dossier d'images de pages ordonnées.",
        replaceSourceImageFolder: "Dossier d'images",
        replaceSourceArchiveFile: "Archive",
        deleteArchiveTitle: "Supprimer l'archive",
        deleteArchiveMessage: "Supprimer l'archive de la base de données ?",
        deleteSeriesTitle: "Supprimer les fichiers de la série",
        deleteSeriesMultipleQuestion: "Supprimer du disque les fichiers de {seriesCount} séries ({issueCount} numéros) ?",
        deleteSeriesSingleQuestionPrefix: "Supprimer du disque les fichiers de la série ",
        deleteSeriesSingleQuestionSuffix: " ?",
    ...
    ja: {
        ...
        updateAvailableContext: "Comic Pile は新しいポータブル版を見つけました。変更内容を確認して、準備ができたらアップデートをダウンロードしてください。",
        updateAvailableReleaseNotesFallback: "このアップデートには詳しいリリースノートがありません。",
        updateAvailableLater: "後で",
        updateAvailableDownload: "アップデートをダウンロード",
        updateDownloadTitle: "アップデートをダウンロード中",
        updateDownloadContext: "Comic Pile はポータブル更新パッケージをダウンロードしています。",
        updateDownloadReadyContext: "ポータブル更新パッケージの準備ができました。",
        updateDownloadPreparingFile: "更新パッケージを準備中...",
        updateDownloadProgressTitle: "ダウンロードの進行状況",
        updateDownloadReadyTitle: "インストールの準備完了",
        updateDownloadReadyMessage: "「アップデートをインストール」を押すと、Comic Pile を閉じて今すぐ適用します。",
        updateDownloadSizeKnown: "{total} 中 {downloaded} をダウンロード済み",
        updateDownloadSizeUnknown: "{downloaded} をダウンロード済み",
        ...
        readerShortcutToggleZoomTool: "ズームツールを切り替え",
        readerShortcutTogglePageZoom: "長押しでページズーム",
        ...
        readerToastPageZoomToolEnabled: "ページズームツールが有効です",
        readerToastPageZoomToolDisabled: "ページズームツールが無効です",
        readerToastPageZoomEnabled: "ページズームが有効です",
        readerToastPageZoomDisabled: "ページズームが無効です",
        ...
        seriesHeaderTitle: "シリーズヘッダー",
        seriesHeaderTheme: "テーマ",
        seriesHeaderMainCover: "メイン表紙",
        seriesHeaderBackground: "背景",
        seriesHeaderShuffle: "シャッフル",
        seriesHeaderUploadCover: "表紙を\nアップロード",
        seriesHeaderUploadBackground: "背景を\nアップロード",
        seriesHeaderResetToDefault: "既定に戻す",
        seriesHeaderContextMissing: "シリーズコンテキストがありません。",
        seriesHeaderPrepareShuffleFailed: "シャッフル背景を準備できませんでした。",
        seriesHeaderSaveFailed: "シリーズヘッダー画像を保存できませんでした。",
        ...
        settingsGeneralAppLanguageScopeNote: "アプリの言語はインターフェイスとヘルプのテキストを変更します。スクリーンショットには英語のUIが表示される場合があります。",
        ...
        aboutSubtitle: "コミックリーダーとライブラリ管理",
        aboutCreatedBy: "作成",
        aboutMadeWith: "協力",
        aboutBuiltWith: "使用技術",
        aboutLicenses: "ライセンス",
        aboutProjectLicense: "プロジェクトライセンス",
        aboutQtLicenses: "Qt ライセンス",
        aboutThirdPartyLicenses: "サードパーティライセンス",
        aboutSourceCode: "ソースコード",
        aboutGitHubRepository: "GitHub リポジトリ",
        aboutBuild: "ビルド",
        aboutUpdates: "アップデート",
        aboutCheckingForUpdates: "確認中...",
        aboutUpToDate: "最新バージョンです",
        aboutCheckForUpdates: "アップデートを確認",
        aboutViewUpdate: "アップデートを見る",
        aboutFooterOpenSource: "© 2026 オープンソースプロジェクト",
        whatsNewPatchNotes: "パッチノート",
        whatsNewNoBundledNotes: "このビルドには同梱されたリリースノートがありません。",
        whatsNewViewAvailableUpdate: "利用可能なアップデートを見る",
        helpScreenshot: "スクリーンショット",
        replaceSourceMessage: "この号を何で置き換えるか選んでください。",
        replaceSourceHint: "別のアーカイブファイル、または順番に並んだページ画像フォルダで置き換えられます。",
        replaceSourceImageFolder: "画像フォルダ",
        replaceSourceArchiveFile: "アーカイブファイル",
        deleteArchiveTitle: "アーカイブファイルを削除",
        deleteArchiveMessage: "データベースからアーカイブファイルを削除しますか?",
        deleteSeriesTitle: "シリーズファイルを削除",
        deleteSeriesMultipleQuestion: "{seriesCount} シリーズ（{issueCount} 号）のファイルをディスクから削除しますか?",
        deleteSeriesSingleQuestionPrefix: "シリーズ ",
        deleteSeriesSingleQuestionSuffix: " のファイルをディスクから削除しますか?",
    ...
    ko: {
        ...
        updateAvailableContext: "Comic Pile이 더 새로운 포터블 버전을 찾았습니다. 변경 내용을 확인한 뒤 준비되면 업데이트를 다운로드하세요.",
        updateAvailableReleaseNotesFallback: "이 업데이트에는 자세한 릴리스 노트가 제공되지 않았습니다.",
        updateAvailableLater: "나중에",
        updateAvailableDownload: "업데이트 다운로드",
        updateDownloadTitle: "업데이트 다운로드 중",
        updateDownloadContext: "Comic Pile이 포터블 업데이트 패키지를 다운로드하고 있습니다.",
        updateDownloadReadyContext: "포터블 업데이트 패키지가 준비되었습니다.",
        updateDownloadPreparingFile: "업데이트 패키지 준비 중...",
        updateDownloadProgressTitle: "다운로드 진행률",
        updateDownloadReadyTitle: "설치 준비 완료",
        updateDownloadReadyMessage: "업데이트 설치를 누르면 Comic Pile을 닫고 지금 적용합니다.",
        updateDownloadSizeKnown: "{total} 중 {downloaded} 다운로드됨",
        updateDownloadSizeUnknown: "{downloaded} 다운로드됨",
        ...
        readerShortcutToggleZoomTool: "확대 도구 전환",
        readerShortcutTogglePageZoom: "길게 눌러 페이지 확대",
        ...
        readerToastPageZoomToolEnabled: "페이지 확대 도구가 켜졌습니다",
        readerToastPageZoomToolDisabled: "페이지 확대 도구가 꺼졌습니다",
        readerToastPageZoomEnabled: "페이지 확대가 켜졌습니다",
        readerToastPageZoomDisabled: "페이지 확대가 꺼졌습니다",
        ...
        seriesHeaderTitle: "시리즈 헤더",
        seriesHeaderTheme: "테마",
        seriesHeaderMainCover: "대표 표지",
        seriesHeaderBackground: "배경",
        seriesHeaderShuffle: "섞기",
        seriesHeaderUploadCover: "표지\n업로드",
        seriesHeaderUploadBackground: "배경\n업로드",
        seriesHeaderResetToDefault: "기본값으로 초기화",
        seriesHeaderContextMissing: "시리즈 컨텍스트가 없습니다.",
        seriesHeaderPrepareShuffleFailed: "섞은 배경을 준비하지 못했습니다.",
        seriesHeaderSaveFailed: "시리즈 헤더 이미지를 저장하지 못했습니다.",
        ...
        settingsGeneralAppLanguageScopeNote: "앱 언어는 인터페이스와 도움말 텍스트를 변경합니다. 스크린샷에는 영어 UI가 표시될 수 있습니다.",
        ...
        topMenuAbout: "정보",
        aboutTitle: "정보",
        aboutSubtitle: "코믹 리더 및 라이브러리 관리자",
        aboutCreatedBy: "제작",
        aboutMadeWith: "함께 제작",
        aboutBuiltWith: "사용 기술",
        aboutLicenses: "라이선스",
        aboutProjectLicense: "프로젝트 라이선스",
        aboutQtLicenses: "Qt 라이선스",
        aboutThirdPartyLicenses: "서드파티 라이선스",
        aboutSourceCode: "소스 코드",
        aboutGitHubRepository: "GitHub 저장소",
        aboutBuild: "빌드",
        aboutUpdates: "업데이트",
        aboutCheckingForUpdates: "확인 중...",
        aboutUpToDate: "최신 버전입니다",
        aboutCheckForUpdates: "업데이트 확인",
        aboutViewUpdate: "업데이트 보기",
        aboutFooterOpenSource: "© 2026 오픈 소스 프로젝트",
        whatsNewPatchNotes: "패치 노트",
        whatsNewNoBundledNotes: "이 빌드에 포함된 릴리스 노트가 없습니다.",
        whatsNewViewAvailableUpdate: "사용 가능한 업데이트 보기",
        helpScreenshot: "스크린샷",
        replaceSourceMessage: "이 이슈를 무엇으로 교체할지 선택하세요.",
        replaceSourceHint: "다른 아카이브 파일이나 정렬된 페이지 이미지 폴더로 교체할 수 있습니다.",
        replaceSourceImageFolder: "이미지 폴더",
        replaceSourceArchiveFile: "아카이브 파일",
        deleteArchiveTitle: "아카이브 파일 삭제",
        deleteArchiveMessage: "데이터베이스에서 아카이브 파일을 삭제할까요?",
        deleteSeriesTitle: "시리즈 파일 삭제",
        deleteSeriesMultipleQuestion: "{seriesCount}개 시리즈({issueCount}개 이슈)의 파일을 디스크에서 삭제할까요?",
        deleteSeriesSingleQuestionPrefix: "시리즈 ",
        deleteSeriesSingleQuestionSuffix: "의 파일을 디스크에서 삭제할까요?",
    ...
    "zh-Hans": {
        ...
        updateAvailableContext: "Comic Pile 找到了更新的便携版。先查看变更内容，准备好后再下载更新。",
        updateAvailableReleaseNotesFallback: "此更新没有提供详细的发行说明。",
        updateAvailableLater: "稍后",
        updateAvailableDownload: "下载更新",
        updateDownloadTitle: "正在下载更新",
        updateDownloadContext: "Comic Pile 正在下载便携更新包。",
        updateDownloadReadyContext: "便携更新包已准备好。",
        updateDownloadPreparingFile: "正在准备更新包...",
        updateDownloadProgressTitle: "下载进度",
        updateDownloadReadyTitle: "可以安装",
        updateDownloadReadyMessage: "点击安装更新会关闭 Comic Pile 并立即应用更新。",
        updateDownloadSizeKnown: "已下载 {downloaded} / {total}",
        updateDownloadSizeUnknown: "已下载 {downloaded}",
        ...
        readerShortcutToggleZoomTool: "切换缩放工具",
        readerShortcutTogglePageZoom: "按住以缩放页面",
        ...
        readerToastPageZoomToolEnabled: "页面缩放工具已启用",
        readerToastPageZoomToolDisabled: "页面缩放工具已禁用",
        readerToastPageZoomEnabled: "页面缩放已启用",
        readerToastPageZoomDisabled: "页面缩放已禁用",
        ...
        seriesHeaderTitle: "系列头图",
        seriesHeaderTheme: "主题",
        seriesHeaderMainCover: "主封面",
        seriesHeaderBackground: "背景",
        seriesHeaderShuffle: "随机",
        seriesHeaderUploadCover: "上传\n封面",
        seriesHeaderUploadBackground: "上传\n背景",
        seriesHeaderResetToDefault: "恢复默认",
        seriesHeaderContextMissing: "缺少系列上下文。",
        seriesHeaderPrepareShuffleFailed: "无法准备随机背景。",
        seriesHeaderSaveFailed: "无法保存系列头图。",
        ...
        settingsGeneralAppLanguageScopeNote: "应用语言会更改界面文本和帮助文本；截图可能仍显示英文界面。",
        ...
        topMenuAbout: "关于",
        aboutTitle: "关于",
        aboutSubtitle: "漫画阅读器和资料库管理器",
        aboutCreatedBy: "创建者",
        aboutMadeWith: "协作工具",
        aboutBuiltWith: "构建技术",
        aboutLicenses: "许可证",
        aboutProjectLicense: "项目许可证",
        aboutQtLicenses: "Qt 许可证",
        aboutThirdPartyLicenses: "第三方许可证",
        aboutSourceCode: "源代码",
        aboutGitHubRepository: "GitHub 仓库",
        aboutBuild: "构建",
        aboutUpdates: "更新",
        aboutCheckingForUpdates: "正在检查...",
        aboutUpToDate: "你已是最新版本",
        aboutCheckForUpdates: "检查更新",
        aboutViewUpdate: "查看更新",
        aboutFooterOpenSource: "© 2026 开源项目",
        whatsNewPatchNotes: "补丁说明",
        whatsNewNoBundledNotes: "此构建没有内置的发行说明。",
        whatsNewViewAvailableUpdate: "查看可用更新",
        helpScreenshot: "截图",
        replaceSourceMessage: "选择要用什么替换这个期数。",
        replaceSourceHint: "你可以用另一个压缩包文件，或一组按顺序排列的页面图片文件夹来替换。",
        replaceSourceImageFolder: "图片文件夹",
        replaceSourceArchiveFile: "压缩包文件",
        deleteArchiveTitle: "删除压缩包文件",
        deleteArchiveMessage: "从数据库中删除压缩包文件？",
        deleteSeriesTitle: "删除系列文件",
        deleteSeriesMultipleQuestion: "要从磁盘删除 {seriesCount} 个系列（{issueCount} 个期数）的文件吗？",
        deleteSeriesSingleQuestionPrefix: "要从磁盘删除系列 ",
        deleteSeriesSingleQuestionSuffix: " 的文件吗？",
    ...
    "zh-Hant": {
        ...
        updateAvailableContext: "Comic Pile 找到了更新的可攜版。先查看變更內容，準備好後再下載更新。",
        updateAvailableReleaseNotesFallback: "此更新沒有提供詳細的版本說明。",
        updateAvailableLater: "稍後",
        updateAvailableDownload: "下載更新",
        updateDownloadTitle: "正在下載更新",
        updateDownloadContext: "Comic Pile 正在下載可攜更新包。",
        updateDownloadReadyContext: "可攜更新包已準備好。",
        updateDownloadPreparingFile: "正在準備更新包...",
        updateDownloadProgressTitle: "下載進度",
        updateDownloadReadyTitle: "可以安裝",
        updateDownloadReadyMessage: "點擊安裝更新會關閉 Comic Pile 並立即套用更新。",
        updateDownloadSizeKnown: "已下載 {downloaded} / {total}",
        updateDownloadSizeUnknown: "已下載 {downloaded}",
        ...
        readerShortcutToggleZoomTool: "切換縮放工具",
        readerShortcutTogglePageZoom: "按住以縮放頁面",
        ...
        readerToastPageZoomToolEnabled: "頁面縮放工具已啟用",
        readerToastPageZoomToolDisabled: "頁面縮放工具已停用",
        readerToastPageZoomEnabled: "頁面縮放已啟用",
        readerToastPageZoomDisabled: "頁面縮放已停用",
        ...
        seriesHeaderTitle: "系列頭圖",
        seriesHeaderTheme: "主題",
        seriesHeaderMainCover: "主封面",
        seriesHeaderBackground: "背景",
        seriesHeaderShuffle: "隨機",
        seriesHeaderUploadCover: "上傳\n封面",
        seriesHeaderUploadBackground: "上傳\n背景",
        seriesHeaderResetToDefault: "恢復預設",
        seriesHeaderContextMissing: "缺少系列內容。",
        seriesHeaderPrepareShuffleFailed: "無法準備隨機背景。",
        seriesHeaderSaveFailed: "無法儲存系列頭圖。",
        ...
        settingsGeneralAppLanguageScopeNote: "應用程式語言會變更介面文字與說明文字；截圖可能仍顯示英文介面。",
        ...
        topMenuAbout: "關於",
        aboutTitle: "關於",
        aboutSubtitle: "漫畫閱讀器與資料庫管理器",
        aboutCreatedBy: "建立者",
        aboutMadeWith: "協作工具",
        aboutBuiltWith: "建置技術",
        aboutLicenses: "授權",
        aboutProjectLicense: "專案授權",
        aboutQtLicenses: "Qt 授權",
        aboutThirdPartyLicenses: "第三方授權",
        aboutSourceCode: "原始碼",
        aboutGitHubRepository: "GitHub 儲存庫",
        aboutBuild: "建置",
        aboutUpdates: "更新",
        ...
        aboutViewUpdate: "查看更新",
        aboutFooterOpenSource: "© 2026 開源專案",
        whatsNewPatchNotes: "更新說明",
        whatsNewNoBundledNotes: "此建置沒有內建的版本說明。",
        whatsNewViewAvailableUpdate: "查看可用更新",
        helpScreenshot: "截圖",
        replaceSourceMessage: "選擇要用什麼取代這一期。",
        replaceSourceHint: "你可以用另一個壓縮檔，或一個已排序頁面圖片的資料夾來取代。",
        replaceSourceImageFolder: "圖片資料夾",
        replaceSourceArchiveFile: "壓縮檔",
        deleteArchiveTitle: "刪除壓縮檔",
        deleteArchiveMessage: "從資料庫中刪除壓縮檔？",
        deleteSeriesTitle: "刪除系列檔案",
        deleteSeriesMultipleQuestion: "要從磁碟刪除 {seriesCount} 個系列（{issueCount} 期）的檔案嗎？",
        deleteSeriesSingleQuestionPrefix: "要從磁碟刪除系列 ",
        deleteSeriesSingleQuestionSuffix: " 的檔案嗎？",
...
var settingsGeneralAppLanguageScopeNote = t("settingsGeneralAppLanguageScopeNote")
...
var settingsReaderZoomTool = t("settingsReaderZoomTool")
...
var settingsOptionTranslations = {
    en: {
        "Focus imported series": "Focus imported series",
        "Open last import": "Open last import",
        "Do nothing": "Do nothing",
        "First series in library": "First series in library",
    ...
    es: {
        "Focus imported series": "Enfocar serie importada",
        "Open last import": "Abrir última importación",
        "Do nothing": "No hacer nada",
        "First series in library": "Primera serie de la biblioteca",
        "Last import": "Última importación",
        "Remember last state": "Recordar último estado",
        "1 page": "1 página",
        "2 pages": "2 páginas",
        Magnifier: "Lupa",
        ...
        Large: "Grande",
        Continue: "Continuar",
        "Stop at boundary": "Detener en el borde",
        Compact: "Compacto",
    ...
    de: {
        "Focus imported series": "Importierte Serie fokussieren",
        "Open last import": "Letzten Import öffnen",
        "Do nothing": "Nichts tun",
        "First series in library": "Erste Serie in der Bibliothek",
        "Last import": "Letzter Import",
        "Remember last state": "Letzten Zustand merken",
        "1 page": "1 Seite",
        "2 pages": "2 Seiten",
        Magnifier: "Lupe",
        ...
        Large: "Groß",
        Continue: "Fortsetzen",
        "Stop at boundary": "Am Rand stoppen",
        Compact: "Kompakt",
        Default: "Standard",
        Comfortable: "Bequem",
        Solid: "Einfarbig",
    ...
    fr: {
        "Focus imported series": "Afficher la série importée",
        "Open last import": "Ouvrir le dernier import",
        "Do nothing": "Ne rien faire",
        "First series in library": "Première série de la bibliothèque",
        "Last import": "Dernier import",
        "Remember last state": "Mémoriser le dernier état",
        "1 page": "1 page",
        "2 pages": "2 pages",
        Magnifier: "Loupe",
        "Page zoom": "Zoom de page",
        Small: "Petit",
        Medium: "Moyen",
        Large: "Grand",
        Continue: "Continuer",
        "Stop at boundary": "Arrêter au bord",
        Compact: "Compact",
        Default: "Par défaut",
    ...
    ja: {
        "Focus imported series": "取り込んだシリーズを表示",
        "Open last import": "最後の取り込みを開く",
        "Do nothing": "何もしない",
        "First series in library": "ライブラリの最初のシリーズ",
        "Last import": "最後の取り込み",
        "Remember last state": "最後の状態を記憶",
        "1 page": "1ページ",
        "2 pages": "2ページ",
        Magnifier: "拡大鏡",
        "Page zoom": "ページズーム",
    ...
    ko: {
        "Focus imported series": "가져온 시리즈로 이동",
        "Open last import": "마지막 가져오기 열기",
        "Do nothing": "아무것도 안 함",
        "First series in library": "라이브러리 첫 시리즈",
        "Last import": "마지막 가져오기",
        "Remember last state": "마지막 상태 기억",
        "1 page": "1페이지",
        "2 pages": "2페이지",
        Magnifier: "돋보기",
        "Page zoom": "페이지 확대",
    ...
    "zh-Hans": {
        "Focus imported series": "聚焦导入的系列",
        "Open last import": "打开上次导入",
        "Do nothing": "不执行操作",
        "First series in library": "资料库中的第一个系列",
        "Last import": "上次导入",
        "Remember last state": "记住上次状态",
        "1 page": "1 页",
        "2 pages": "2 页",
        Magnifier: "放大镜",
        "Page zoom": "页面缩放",
    ...
    "zh-Hant": {
        "Focus imported series": "聚焦匯入的系列",
        "Open last import": "開啟上次匯入",
        "Do nothing": "不執行操作",
        "First series in library": "資料庫中的第一個系列",
        "Last import": "上次匯入",
        "Remember last state": "記住上次狀態",
        "1 page": "1 頁",
        "2 pages": "2 頁",
        Magnifier: "放大鏡",
        "Page zoom": "頁面縮放",
...
function settingsOptionLabel(valueKey, optionValue, language) {
    const key = String(valueKey || "").trim()
    const value = String(optionValue || "").trim()
    if (key === "general_app_language" || value.length < 1) {
        return value
    }
    const languageCode = normalizedLanguageCode(language)
    const languageOptions = settingsOptionTranslations[languageCode] || {}
    if (hasTextKey(languageOptions, value)) {
        return String(languageOptions[value])
    }
    const fallbackOptions = settingsOptionTranslations[fallbackLanguageCode] || {}
    if (hasTextKey(fallbackOptions, value)) {
        return String(fallbackOptions[value])
    }
    return value
}
