...
var translations = {
    en: {
        ...
        updateAvailableContext: "Comic Pile found a newer portable release. Review what changed, then download it when you're ready.",
    ...
    es: {
        ...
        updateAvailableContext: "Comic Pile encontró una versión portable más reciente. Revisa qué cambió y descárgala cuando quieras.",
    ...
    de: {
        ...
        updateAvailablePatchLabel: "Patch {version}",
        updateAvailableContext: "Comic Pile hat eine neuere portable Version gefunden. Prüfe, was sich geändert hat, und lade sie herunter, wenn du bereit bist.",
    ...
    fr: {
        ...
        updateAvailableContext: "Comic Pile a trouvé une version portable plus récente. Vérifie ce qui a changé, puis télécharge-la quand tu es prêt.",
    ...
    ja: {
        ...
        updateAvailableContext: "Comic Pile は新しいポータブル版を見つけました。変更内容を確認して、準備ができたらダウンロードしてください。",
    ...
    ko: {
        ...
        updateAvailableContext: "Comic Pile이 더 새로운 포터블 버전을 찾았습니다. 변경 내용을 확인한 뒤 준비되면 다운로드하세요.",
    ...
    "zh-Hans": {
        ...
        updateAvailableContext: "Comic Pile 找到了更新的便携版。先查看变更内容，准备好后再下载。",
    ...
    "zh-Hant": {
        ...
        updateAvailableContext: "Comic Pile 找到了更新的可攜版。先查看變更內容，準備好後再下載。",
