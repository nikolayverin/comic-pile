...
var translations = {
    en: {
        ...
        updateDownloadContext: "Comic Pile is downloading the portable update package. When the download finishes, you can install it right away.",
    ...
    es: {
        ...
        updateDownloadContext: "Comic Pile está descargando el paquete portable de actualización. Cuando termine, podrás instalarlo de inmediato.",
    ...
    de: {
        ...
        updateDownloadContext: "Comic Pile lädt das portable Update-Paket herunter. Wenn der Download fertig ist, kannst du es direkt installieren.",
    ...
    fr: {
        ...
        updateDownloadContext: "Comic Pile télécharge le paquet portable de mise à jour. Une fois le téléchargement terminé, tu pourras l'installer tout de suite.",
    ...
    ja: {
        ...
        updateDownloadContext: "Comic Pile はポータブル更新パッケージをダウンロードしています。完了したらすぐにインストールできます。",
    ...
    ko: {
        ...
        updateDownloadContext: "Comic Pile이 포터블 업데이트 패키지를 다운로드하고 있습니다. 다운로드가 끝나면 바로 설치할 수 있습니다.",
    ...
    "zh-Hans": {
        ...
        updateDownloadContext: "Comic Pile 正在下载便携更新包。下载完成后，你可以立即安装。",
    ...
    "zh-Hant": {
        ...
        updateDownloadContext: "Comic Pile 正在下載可攜更新包。下載完成後，你可以立即安裝。",
