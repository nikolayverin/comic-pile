    ...
    readonly property var helpSectionsPartB: [
        {
            ...
            subsections: [
                ...
                },
                {
                    ...
                    bodyHtml: "A popup appears only when the app finds one clear saved match in your library data.<br><br><b>For issue details</b><br>The same <b>Series</b> and <b>Issue</b> must match first. The app then checks support fields such as <b>Volume</b>, <b>Publisher</b>, and <b>Year</b> to decide whether this saved issue is likely the same one. <b>Title</b>, <b>Month</b>, and <b>Age rating</b> can help refine the match, but they do not have to match first.<br><br><b>For series details</b><br>The same <b>Series</b> must match first. The popup then needs at least one supporting match in <b>Volume</b>, <b>Publisher</b>, <b>Year</b>, <b>Month</b>, or <b>Age rating</b>. <b>Series title</b>, <b>Summary</b>, and <b>Genres</b> do not trigger the popup by themselves, but they can still be filled after a match is found.<br><br>If the saved data conflicts with what is already in the form, or if there is no one clear best match, the popup does not appear.<br><br>If you choose <b>Fill from library</b>, only the remaining empty fields are filled automatically. If you choose <b>Keep current values</b>, the form is saved as it is and those current values become the saved source for future autofill.",
