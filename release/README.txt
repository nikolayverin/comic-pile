...
Bug reports:
- GitHub Issues: https://github.com/nikolayverin/comic-pile/issues
...
- your Comic Pile version from About

Open source notices:
- see the `License` folder included with the release package
